...
class table extends App {
    ...
    onload() {
        ...
        let profiles = 'city education professional has_social_security has_accumulation_fund house_property car'.split(' ');
        let profiles_cn = '城市 学历 职业 社保 公积金 房产 汽车'.split(' ');
