  ...
  var table = (function (_App) {
      ...
      _createClass(table, [{
          ...
          value: function onload() {
              ...
              var profiles = 'username tel score gender sid client loan city education professional has_social_security has_accumulation_fund house_property car'.split(' ');
              var profiles_cn = '姓名 手机 评分 性别 渠道 终端 贷款金额 城市 学历 职业 社保 公积金 房产 汽车'.split(' ');
